 ...
 * Will use environment variable MONGODB_URI, or fallback to a demo mode for development
 */
export async function connectToDatabase(): Promise<typeof mongoose> {
  ...
  if (!cached.promise) {
    ...
    console.log('Connecting to MongoDB...', MONGODB_URI.substring(0, MONGODB_URI.indexOf('@') > 0 ? MONGODB_URI.indexOf('@') : 20) + '...');
